...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.openMenu = function (name) {
        var selectedDay = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.findIndex(this.categories, function (category) { return category.name === name; });
...
var NavbarProfileComponent = (function () {
    ...
    NavbarProfileComponent.prototype.openMenu = function (name) {
        var selectedDay = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.findIndex(this.categories, function (category) { return category.name === name; });
        var selectedMenu = this.categories[selectedDay];
        this.homeService.sendSubCategoryId(selectedMenu._id);

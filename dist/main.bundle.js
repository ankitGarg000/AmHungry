...
module.exports = " <div *ngIf=\"loader\" id=\"loading\">\n  <div id=\"loading-center\">\n    <img src=\"/assets/images/loader.gif\" alt=\"\">\n  </div>\n</div>\n <router-outlet></router-outlet>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commonComponents_remove_item_modal_remove_item_modal_component__ = __webpack_require__("../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CartItemsComponent = (function () {
        ...
        this.homeService.getCartDetails().subscribe(function (items) {
            ...
            if (_this.cartItems) {
                _this.cartItems.map(function (cartItem) {
                    ...
                    _this.itemArray.push(_this.itemObj);
                });
    ...
    CartItemsComponent.prototype.removeItemModalShow = function (id) {
        this.itemId = id;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])('removeItemModal'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__commonComponents_remove_item_modal_remove_item_modal_component__["a" /* RemoveItemModalComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__commonComponents_remove_item_modal_remove_item_modal_component__["a" /* RemoveItemModalComponent */]) === "function" && _b || Object)
], CartItemsComponent.prototype, "removeItemModal", void 0);
CartItemsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__home_service__["a" /* HomeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__home_service__["a" /* HomeService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_3_ng2_toasty__["c" /* ToastyService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ng2_toasty__["c" /* ToastyService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_3_ng2_toasty__["a" /* ToastyConfig */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ng2_toasty__["a" /* ToastyConfig */]) === "function" && _g || Object])
], CartItemsComponent);
...
// module
exports.push([module.i, ".footer-text {\n    float: left;\n}\n.footer-text .text-white {\n    margin-top: 15px !important;\n}\n\n.footer-facebook-icon {\n    float: right;\n    margin-top: 11px;\n}", ""]);
    ...
    GenerateOrderModalComponent.prototype.order = function (value) {
        ...
        this.homeService.generateOrder(data).subscribe(function (data) {
            if (data.statusCode === 200) {
                ...
                setTimeout(function () {
                    _this.homeService.sendCount(-(_this.products.length));
...
module.exports = "<header id=\"header\" [ngClass]=\"{'page-scroll-header': isScrolled}\" class=\"header\">\n  <nav class=\"navbar navbar-default\">\n    <div class=\"container-fluid\">\n      <div class=\"navbar-header\">\n        <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\"#myNavbar\">\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>                        \n      </button>\n        <a class=\"navbar-brand amhungry-logo\" [routerLink]=\"['../']\"><img [ngClass]=\"{'page-scroll-header-img': isScrolled}\" id=\"logo_img\" src=\"/assets/images/amhungry-logo.png\" alt=\"logo\"></a>\n      </div>\n      <div class=\"collapse navbar-collapse\" id=\"myNavbar\">\n        <ul class=\"nav navbar-nav navbar-right\">\n          <li>\n            <a routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{exact: true}\" [routerLink]=\"['/home']\" href=\"javascript:void(0)\"> Home </a>\n          </li>\n          <li><a style=\"cursor: pointer;\" (click)=\"open()\">Login</a></li>\n          <li class=\"dropdown\">\n            <a class=\"dropdown-toggle\" data-toggle=\"dropdown\">Menu&nbsp;<span class=\"caret\"></span></a>\n            <ul class=\"dropdown-menu\">\n              <!--<li *ngFor=\"let category of categories\">\n              </li>-->\n              <li *ngFor=\"let day of days;let i=index\">\n                  <a *ngIf=\"day !== 'Tuesday'\" (click)=\"dayName==day.toLowerCase() && openMenu(day.toLowerCase())\" [ngClass]=\"dayName==day.toLowerCase()?'makeClikable':'disabled'\" >\n                    {{day}}\n                  </a>\n                  <!--<a [ngClass]=\"dayName==days[1].toLowerC?'makeClikable':'disabled'\" (click)=\"dayName==days[1] && openMenu(days[1])\">\n                    Monday's Menu\n                </a>-->\n              </li>\n              <!--<li>\n                <a [ngClass]=\"dayName==days[1].toLowerC?'makeClikable':'disabled'\" (click)=\"dayName==days[1] && openMenu(days[1])\">\n                    Monday's Menu\n                </a>\n              </li>\n              <li>\n                <a [ngClass]=\"dayName==days[3]?'makeClikable':'disabled'\" (click)=\"dayName==days[3] && openMenu(days[3])\">\n                    Wednesday's Menu\n                </a>\n              </li>\n              <li>\n                <a [ngClass]=\"dayName=='THURSDAY'?'makeClikable':'disabled'\" (click)=\"dayName=='THURSDAY' && openMenu('THURSDAY')\">\n                    THURSDAY\n                </a>\n              </li>\n              <li>\n                <a [ngClass]=\"dayName=='FRIDAY'?'makeClikable':'disabled'\" (click)=\"dayName=='FRIDAY' && openMenu('FRIDAY')\">\n                    FRIDAY\n                </a>\n              </li>\n              <li>\n                <a [ngClass]=\"dayName=='SATURDAY'?'makeClikable':'disabled'\" (click)=\"dayName=='SATURDAY' && openMenu('SATURDAY')\">\n                    SATURDAY\n                </a>\n              </li>\n              <li>\n                <a [ngClass]=\"dayName=='SUNDAY' ?'makeClikable':'disabled'\" (click)=\"dayName=='SUNDAY' && openMenu('SUNDAY')\">\n                    SUNDAY\n                </a>\n              </li>-->\n            </ul>\n          </li>\n          <li><a routerLinkActive=\"active\" href=\"javascript:void(0)\" [routerLink]=\"['./', 'about']\">About us</a>\n          </li>\n          <li><a routerLinkActive=\"active\" href=\"javascript:void(0)\" [routerLink]=\"['./', 'contact']\"> Contact us</a></li>\n        </ul>\n      </div>\n    </div>\n  </nav>\n  <img (click)=\"open()\" id=\"cart\" src=\"/assets/images/shopping_cart.png\" />\n</header>\n<app-login-modal #childModal [title]=\"'Login'\"></app-login-modal>"
...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.getWeekDayName = function () {
        var date = new Date();
    ...
    NavbarComponent.prototype.openMenu = function (name) {
        var todayDayName = name.toLowerCase();
        var selectedDay = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.findIndex(this.categories, function (category) { return __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.includes(category.name.toLowerCase(), name); });
        var selectedMenu = this.categories[selectedDay];
...
/***/ "../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".remove-button {\n    background-color: #e93e21 !important;\n    color: white !important;\n    border: none !important;\n}", ""]);
...
/***/ "../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.html":
/***/ (function(module, exports) {

module.exports = "  <div bsModal #removeItemModal=\"bs-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"mySmallModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h4 class=\"modal-title pull-left\">{{title}}</h4>\n        <button type=\"button\" class=\"close pull-right\" aria-label=\"Close\" (click)=\"hide()\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"row\">\n      <div class=\"col-lg-12\">\n        <p>Are you sure, you want to remove this item ?</p>\n      </div>\n    </div>\n      </div>\n\n      <div class=\"modal-footer\">\n        <div class=\"pull-right\">\n          <button class=\"btn btn-default\" (click)=\"hide()\"> Cancel </button>\n          <button class=\"btn btn-default remove-button\" (click)=\"removeItem()\"> Remove </button>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RemoveItemModalComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ng2_bootstrap_ng2_bootstrap__ = __webpack_require__("../../../../ng2-bootstrap/ng2-bootstrap.js");
...
var RemoveItemModalComponent = (function () {
    function RemoveItemModalComponent(router, homeService, route, toastyService, toastyConfig) {
        this.router = router;
        this.homeService = homeService;
        this.route = route;
        this.toastyService = toastyService;
    ...
    RemoveItemModalComponent.prototype.ngOnInit = function () {
    };
    RemoveItemModalComponent.prototype.show = function () {
        this.removeItemModal.show();
    };
    RemoveItemModalComponent.prototype.hide = function () {
        this.removeItemModal.hide();
    };
    RemoveItemModalComponent.prototype.removeItem = function () {
        var _this = this;
        var id = this.itemId;
        this.homeService.removeItemFromCart(id).subscribe(function (data) {
            ...
            if (data.statusCode === 200) {
                ...
                _this.router.navigate(['/home/profile/cartItems']);
            }
            else {
                var toastOptions = {
                    title: "",
    ...
    return RemoveItemModalComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])('removeItemModal'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ng2_bootstrap_ng2_bootstrap__["a" /* ModalDirective */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ng2_bootstrap_ng2_bootstrap__["a" /* ModalDirective */]) === "function" && _a || Object)
], RemoveItemModalComponent.prototype, "removeItemModal", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", String)
], RemoveItemModalComponent.prototype, "itemId", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", String)
], RemoveItemModalComponent.prototype, "title", void 0);
RemoveItemModalComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-remove-item-modal',
        template: __webpack_require__("../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.html"),
        styles: [__webpack_require__("../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__home_service__["a" /* HomeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__home_service__["a" /* HomeService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* ActivatedRoute */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4_ng2_toasty__["c" /* ToastyService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ng2_toasty__["c" /* ToastyService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4_ng2_toasty__["a" /* ToastyConfig */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ng2_toasty__["a" /* ToastyConfig */]) === "function" && _f || Object])
], RemoveItemModalComponent);

var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=/home/admin-nk/Desktop/AmHungry/src/remove-item-modal.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__commonComponents_remove_item_modal_remove_item_modal_component__ = __webpack_require__("../../../../../src/app/home/commonComponents/remove-item-modal/remove-item-modal.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
HomeModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_25__commonComponents_remove_item_modal_remove_item_modal_component__["a" /* RemoveItemModalComponent */]
        ],
        imports: [
...
var NavbarProfileComponent = (function () {
    ...
    NavbarProfileComponent.prototype.getWeekDayName = function () {
        var date = new Date();
    ...
    NavbarProfileComponent.prototype.openMenu = function (name) {
        var todayDayName = name.toLowerCase();
        var selectedDay = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.findIndex(this.categories, function (category) { return __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.includes(category.name.toLowerCase(), name); });
        var selectedMenu = this.categories[selectedDay];
        this.homeService.sendSubCategoryId(selectedMenu._id);
...
module.exports = "<!--=================================\ntestimonials -->\n\n<section class=\"testimonials\">\n  <div class=\"object-bottom-top\">\n    <div class=\"object-right\">\n      <img class=\"img-responsive\" src=\"/assets/images/object/05.png\" alt=\"\">\n    </div>\n  </div>\n  <div class=\"page-section-ptb\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col-lg-12 col-md-12\">\n          <div class=\"section-title text-center\">\n            <div class=\"title-separator\">\n              <div class=\"knife-test\">\n                <!-- <i class=\"line col-xs-1\"></i> -->\n                <img src=\"/assets/images/knife.png\" class=\"img-responsive\">\n                <!-- <i class=\"line col-xs-1\"></i> -->\n              </div>\n            </div>\n            <h2> <span class=\"text-orange\">Our </span> testimonials</h2>\n            <p>What Our Happy Clients say about us</p>\n          </div>\n        </div>\n      </div>\n      <div class=\"row\">\n        <div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\">\n          <div class=\"testimonial-block left\">\n            <div class=\"testimonial-info clearfix\">\n              <strong>Sourav</strong>\n              <span>India</span>\n              <p>Hi, I have been purchasing your food for a while and I want to say how much i love\n                your product. keep up the great work and congrats\n                on the yumminess!</p>\n            </div>\n          </div>\n        </div>\n        <div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\">\n          <div class=\"testimonial-block left\">\n            <div class=\"testimonial-info clearfix\">\n              <strong>Shilpa</strong>\n              <span>India</span>\n              <p>I just wanted to say thank you for your delicious products. My husband and I have been thoroughly enjoying\n                the food</p>\n            </div>\n          </div>\n        </div>\n        <div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\">\n          <div class=\"testimonial-block left\">\n            <div class=\"testimonial-info clearfix\">\n              <strong>Monty</strong>\n              <span>India</span>\n              <p>I just wanted to write to you and tell you how much I love the Clusters! The ingredients, the taste, texture\n                and how good it is nutritionally.</p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>\n\n<!--=================================\ntestimonials -->"
...
var TodaySpecialMenuComponent = (function () {
    ...
    TodaySpecialMenuComponent.prototype.goToMenu = function (name) {
        var todayDayName = name.toLowerCase();
        var phoneNo = JSON.parse(localStorage.getItem('phoneNumber'));
        var selectedDay = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.findIndex(this.categories, function (category) { return __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.includes(category.name.toLowerCase(), todayDayName); });
        var selectedMenu = this.categories[selectedDay];
        var id = selectedMenu._id;
        if (phoneNo) {
